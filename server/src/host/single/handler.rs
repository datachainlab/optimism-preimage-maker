...
impl DerivationRequest {
    ...
    pub async fn run_server(&self, preimage_host: NativeChannel, hint_host: NativeChannel, backend: OnlineHostBackend<SingleChainHost, SingleChainHintHandler>) -> Result<()> {
        PreimageServer::new(
    ...
    pub async fn run_client(&self, preimage_client: NativeChannel, hint_client: NativeChannel) -> Result<()> {
