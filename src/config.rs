...
impl Config {
    pub async fn create_providers(
        ...
        let beacon_client = OnlineBeaconClient::new_http(self.l1_beacon_address.clone());
        ...
        let l1_provider = http_provider(&self.l1_node_address);
        let l2_provider = http_provider(&self.l2_node_address);
